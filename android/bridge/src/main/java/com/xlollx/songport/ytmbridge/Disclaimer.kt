...
object Disclaimer {
    ...
    fun require(activity: Activity, onAccepted: () -> Unit) {
        ...
        AlertDialog.Builder(activity)
            .setTitle(R.string.bridge_disclaimer_title)
            .setMessage(R.string.bridge_disclaimer_body)
            .setCancelable(false)
            .setPositiveButton(R.string.bridge_disclaimer_accept) { _, _ -> accept(activity); onAccepted() }
