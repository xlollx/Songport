...
- Connections log in Settings › Developer options (off by default, with the technical report and the traffic capture), and a plain "where does the key go?" in the AI setup.
